...
* @sec-precisionaccuracy Understanding precision and accuracy.
* @sec-significantfigures Understanding significant figures and how to count them.
* @sec-howmanysf How many significant figures are there?
* @sec-readingvalues Making measurements and reading scales.
* @sec-roundtoeven Rounding to even.

Chapter @sec-chapter2

* @sec-sfaddsub Using significant figures in addition and subtraction.
* @sec-sfmuldiv Using significant figures in multiplication and division.
* @sec-sflog Using significant figures with logs.
...
* @sec-averages Calculating averages to appropriate significant figures.
* @sec-standarddeviation Understanding data distribution and standard deviation.

Chapter 4: The Standard Errord
...
```{=html}
<iframe src="https://forms.office.com/Pages/ResponsePage.aspx?id=Ij1-N6FOLUKwrY_MiUBrniNYfTgBocZNjOvM4G_WxTZUQkNKQjNIRTVKTzBBRThEVjNQS1lCV0RTUC4u&embed=true" frameborder="0" marginwidth="0" marginheight="0" style="border: none; max-width:100%; max-height:100vh" allowfullscreen webkitallowfullscreen mozallowfullscreen msallowfullscreen" width="640" height="480"></iframe>
```
