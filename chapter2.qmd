...
:::{.callout-caution title="Example calculation using powers."}
...
When taking an antilog (so for example $10^x$ or $e^x$) we should retain the same number of significant figures if our exponent is between 0 and 1.

If our exponent is less than 0 or greater than 1 then we should loose a significant figure.
:::